Here is the Optuna-enhanced metaheuristic based on the template:

# Name: Random Sample Metaheuristic Optimizer
# Code:
...
def objective(trial):
    heur = [
        (
        'random_sample',
        {'parameter1': trial.suggest_float('param1', 0.1, 0.9),
        'parameter2': trial.suggest_float('param2', 0.1, 0.9)},
        'greedy'
    )
    ]

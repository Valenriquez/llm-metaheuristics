...
class MetaheuristicGenerator:
    ...
    def self_refine(self, initial_prompt, data, output_folder):
            ...
            for i in range(self.max_iterations):
                ...
                # Retrieve relevant feedback and construct refinement prompt
                refinement_prompt = self.construct_refinement_prompt(current_output, execution_result, data, i)
    ...
    def run(self):
        ...
        try:
            ...
            refined_output = self.self_refine(prompt, data, output_folder)

...
This script should now run correctly without indentation errors. Make sure that all lines are properly indented according to Python syntax rules, and there is no extra whitespace or indentation at the start of the file.
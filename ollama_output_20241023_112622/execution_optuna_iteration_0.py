 # Name: Optuna-Enhanced Gravitational Search with Local Random Walk
# Code:
...
def objective(trial):
    heur = [
        ('gravitational_search', {
            'gravity': trial.suggest_float('gravity', 0.01, 1.0),
            'alpha': trial.suggest_float('alpha', 0.01, 0.02)
        }, 'all'),
        ('local_random_walk', {
            'probability': trial.suggest_float('probability', 0.01, 0.75),

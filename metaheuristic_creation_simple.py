"""
This file generates metaheuristics. 
Optuna is NOT implemented 
A very large prompt is implemented. And a collection with the python files too. 
"""
...
sys.path.append('llm-metaheuristics/metaheuristic_builder')
...
python_files_dir = 'llm-metaheuristics/metaheuristic_builder'

 # Create a collection for Python files
collection = client.create_collection(name="metaheuristic_builder")
...
def self_refine(initial_prompt, data, model, output_folder, max_iterations=7, python_files_dir='llm-metaheuristics/metaheuristic_builder'):

...
def objective(trial):
    heur = [
        ("local_random_walk",
         {"probability": trial.suggest_float('local_random_walk_probability', 0.1, 0.9),
          "scale": trial.suggest_float('local_random_walk_scale', 0.1, 2.0),
          "distribution": trial.suggest_categorical('local_random_walk_distribution', ['normal', 'levy'])},
         "greedy")
    ]

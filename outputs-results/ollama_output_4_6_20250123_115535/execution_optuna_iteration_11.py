...
def objective(trial):
    heur = [
        ('random_search', 
         ...
         'metropolis'),
        ('firefly_dynamic', 
         {'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian', 'levy']), 'alpha': trial.suggest_float('alpha', 0.1, 0.2), 'beta': trial.suggest_float('beta', 1.75, 1.9), 'gamma': trial.suggest_int('gamma', 80, 100)}, 
         'probabilistic'),
        ('gravitational_search', 
         {'gravity': trial.suggest_float('gravity', 0.05, 0.08), 'alpha': trial.suggest_float('alpha', 0.01, 0.03)}, 
         'greedy'),
        ('swarm_dynamic', 
         {'factor': trial.suggest_float('factor', 0.7, 0.8), 'self_conf': trial.suggest_float('self_conf', 2.4, 2.6), 'swarm_conf': trial.suggest_float('swarm_conf', 2.5, 2.7), 'version': trial.suggest_categorical('version', ['inertial', 'constriction']), 'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian', 'levy'])}, 
         'all'),
    ]
...
print("Rendimiento:", study.best_value)
...
def objective(trial):
    heur = [
        ...
        ('central_force_dynamic', 
         {'gravity': trial.suggest_float('gravity', 0.001, 0.008), 'alpha': trial.suggest_float('alpha', 0.01, 0.03), 'beta': trial.suggest_float('beta', 1.5, 4.5), 'dt': trial.suggest_float('dt', 0.5, 1.0)}, 
         'probabilistic'),
    
        ('genetic_crossover', 
         {'pairing': trial.suggest_categorical('pairing', ['rank', 'cost', 'random']), 'crossover': trial.suggest_categorical('crossover', ['blend', 'uniform', 'linear_0.5_0.5']), 'mating_pool_factor': trial.suggest_float('mating_pool_factor', 0.3, 0.6)}, 
         'all'),
    ]

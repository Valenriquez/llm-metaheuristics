...
heur = [
    ('random_search', 
     {'scale': 0.02142330438833214, 'distribution': 'gaussian'}, 
     'metropolis'),
    
    ('central_force_dynamic', 
     {'gravity': 0.007882733223293727, 'alpha': 0.043871990776169496, 'beta': 1.5814215065744817, 'dt': 0.5415954481053958}, 
     'probabilistic'),

    ('differential_mutation', 
     {'expression': 'rand-to-best-and-current', 'num_rands': 2, 'factor': 1.6543301154824326}, 
     'all')
]    

...
def objective(trial):
    heur = [
        ('random_search', {'scale': trial.suggest_float('scale', 0.01, 0.1)}, 'probabilistic'),
        ('central_force_dynamic', {'gravity': trial.suggest_float('gravity', 0.01, 0.2), 'alpha': trial.suggest_float('alpha', 0.05, 0.3), 'beta': trial.suggest_float('beta', 1.6, 2.2), 'dt': trial.suggest_float('dt', 1.0, 2.0)}, 'metropolis'),
        ('firefly_dynamic', {'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian', 'levy']), 'alpha': trial.suggest_float('alpha', 0.8, 1.0), 'beta': trial.suggest_float('beta', 0.7, 0.9), 'gamma': trial.suggest_float('gamma', 100.0, 150.0)}, 'greedy')
    ]

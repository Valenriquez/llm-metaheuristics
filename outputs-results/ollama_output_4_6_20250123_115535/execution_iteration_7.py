# This is the Python Iteration: 7
# Author: [Your Name]
# Date: [Insert Date]
...
heur = [
    (  # Search operator 1
        ...
        {
            'gravity': 0.05593447758441197,
            'alpha': 0.16215210737325647,
            'beta': 1.779127684912272,
            'dt': 0.5937260990651896
        },
        'greedy'
    ),
    (
        'spiral_dynamic',
        {
            'radius': 0.7333625203966673,
            'angle': 23.107087503693766,
            'sigma': 0.09259480191005011
        },
        'metropolis'
    ),
    (
    ...
    (
        'local_random_walk',
        {
            'probability': 0.7477862041051271,
            'scale': 0.015138099792565885,

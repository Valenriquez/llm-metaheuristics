...
def objective(trial):
    heur = [
        ('random_search',
            {
                'scale': trial.suggest_float('scale', 0.01, 0.02),
        ...
        ('central_force_dynamic',
            {
                ...
                'alpha': trial.suggest_float('alpha', 0.15, 0.2),
                'beta': trial.suggest_float('beta', 1.8, 2.2),
                'dt': trial.suggest_float('dt', 0.7, 0.9)
            },
            'metropolis'),
        ('firefly_dynamic',
            {
                ...
                'gamma': trial.suggest_int('gamma', 90, 110)
            },
            'probabilistic')
    ]

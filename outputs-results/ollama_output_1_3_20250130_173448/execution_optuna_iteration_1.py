...
def objective(trial):
    heur = [
        ('central_force_dynamic',
         {
             ...
             'alpha': trial.suggest_float('alpha', 0.02, 0.3),
             'beta': trial.suggest_float('beta', 1.5, 1.8),
             'dt': trial.suggest_float('dt', 0.5, 1.5)
         },
         'metropolis'),
        ('differential_mutation',
         {
             'expression': trial.suggest_categorical('expression', ['rand', 'best', 'current-to-best']),
        ...
        ('gravitational_search',
         {
             'gravity': trial.suggest_float('gravity', 0.1, 0.6),
             'alpha': trial.suggest_float('alpha', 0.03, 0.15)
         },
         'greedy'),
        ('random_flight',
         {
             'scale': trial.suggest_float('scale', 1.0, 2.0),

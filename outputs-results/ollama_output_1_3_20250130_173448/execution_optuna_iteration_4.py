...
def objective(trial):
    heur = [
        ...
        ('central_force_dynamic',
            {
                'gravity': trial.suggest_float('gravity', 0.003, 0.007),
                'alpha': trial.suggest_float('alpha', 0.015, 0.025),
        ...
        ('differential_mutation',
            {
                ...
                'num_rands': 2,
                'factor': trial.suggest_float('factor', 1.0, 1.8)
            },
            'greedy'),
        ('firefly_dynamic',
            {
                ...
                'gamma': trial.suggest_float('gamma', 75.0, 90.0)
            },
            'all'),
    ]

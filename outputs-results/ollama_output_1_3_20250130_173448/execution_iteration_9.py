...
heur = [
    (
        ...
        {
            'gravity': 0.004894561226484363,
            'alpha': 0.014528071904754462,
            'beta': 2.1659222353699397,
            'dt': 0.7719013766751468
        },
        'probabilistic'
    ),
    (
        'spiral_dynamic',
        {
            'radius': 0.7730402261154551,
            'angle': 23.52744997192215,
            'sigma': 0.1019483874812262
        },
        'all'
    ),
    (

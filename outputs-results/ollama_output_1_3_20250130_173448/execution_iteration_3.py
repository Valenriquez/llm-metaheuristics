...
heur = [
    (
        ...
        {
            'gravity': 0.18043448988632088,
            'alpha': 0.13995783546601184,
            'beta': 4.4498257005566515,
            'dt': 1.3880117164426027
        },
        'metropolis'
    ),
    (
    ...
    (
        'genetic_crossover',
        {
            'pairing': 'random',
            'crossover': 'two',
            'mating_pool_factor': 0.46901868249359635
        },
        'all'
    )
]    

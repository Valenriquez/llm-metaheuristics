...
heur = [
    ('random_search', 
     {
         'scale': 0.010082701309911884, 
         'distribution': 'uniform'
     }, 
     'metropolis'),
    ('central_force_dynamic', 
     {
         'gravity': 0.006417663605714038, 
         'alpha': 0.021589994987318378, 
         'beta': 4.072168049925904, 
         'dt': 0.45444872725054375
     }, 
     'greedy'),
    ('differential_mutation', 
     {
         'expression': 'best', 
         'num_rands': 1, 
         'factor': 1.066116161937813
     }, 
     'probabilistic'),
    ('spiral_dynamic', 
     {
         'radius': 0.5518012668231971, 
         'angle': 40.062504796003665, 
         'sigma': 0.06326010562539003
     }, 
     'all')
]    
...
num_agents= 57    
num_iterations = 100
num_replicas = 100 # Adjust the number of replicas as needed

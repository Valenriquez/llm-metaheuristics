...
heur = [
    ('random_search',
        {
            'scale': 0.004726233070426717,
            'distribution': 'levy'
        },
        'metropolis'),
    ('central_force_dynamic',
        {
            'gravity': 0.0043238786628876594,
            'alpha': 0.015577229124670553,
            'beta': 1.8297534509914692,
            'dt': 0.8118274806347647
        },
        'probabilistic'),
    ('differential_mutation',
        {
            'expression': 'best',
            'factor': 1.0454396963444201
        },
        'greedy'),
    ('firefly_dynamic',
        {
            'gamma': 79.27096559956615
        },
        'all')
]    

...
def objective(trial):
    heur = [
        ...
        'spiral_dynamic',
        {
            ...
            'angle': trial.suggest_float('angle', 2, 22),
    ...
    (
        'swarm_dynamic',
        {
            'factor': trial.suggest_float('factor', 0.4, 0.6),
            'self_conf': trial.suggest_float('self_conf', 2.1, 2.4),
            'swarm_conf': trial.suggest_float('swarm_conf', 2.3, 2.5),

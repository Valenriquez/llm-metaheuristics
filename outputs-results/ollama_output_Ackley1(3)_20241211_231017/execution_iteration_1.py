...
heur = [
    ...
    (
        'swarm_dynamic',
        {
            'factor': 0.10020311837133605,
            'self_conf': 2.009970420691297,
            'swarm_conf': 2.2652497069607644,
            'version': 'inertial',
    ...
    (
        ...
        {
            'radius': 0.9,
            'angle': 18.745830145881584,
            'sigma': 0.0948785842435465
        },
        'metropolis'
    )
]
...
# In each iteration, 30 runs of the metaheuristic are performed, adjusting the number of agents based on the dimensionality (2 agents for a 3-dimensional problem). The fitness data is collected over these iterations to evaluate the effectiveness of the hybrid metaheuristic.
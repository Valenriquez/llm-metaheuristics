...
def objective(trial):
    ...
    ('swarm_dynamic',
        {
            ...
            'self_conf': trial.suggest_float('self_conf', 1.8, 2.7),
            'swarm_conf': trial.suggest_float('swarm_conf', 2.3, 2.6),
    ...
    ('spiral_dynamic',
        {
            'radius': trial.suggest_float('radius', 0.5, 0.89),
            'angle': trial.suggest_float('angle', 20.0, 30.0),
            'sigma': trial.suggest_float('sigma', 0.01, 0.04)
        },
        'greedy'),
    ]

...
heur = [
    ('random_search', 
        {'scale': 0.004229223533688824}, 
        'metropolis'
    ),
    ('central_force_dynamic', 
        {'gravity': 0.0019490997236598113, 'alpha': 0.01152143176477042, 'beta': 1.4980917930028266, 'dt': 1.0686666087727548}, 
        'probabilistic'
    ),
    ('genetic_crossover', 
        {'pairing': 'tournament_2_100', 'crossover': 'blend', 'mating_pool_factor': 0.40581088343902877}, 
        'greedy'
    ),
    ('spiral_dynamic', 
        {'radius': 0.8519738790655852, 'angle': 23.775372193014903, 'sigma': 0.061104274095346925}, 
        'all'
    )
]    

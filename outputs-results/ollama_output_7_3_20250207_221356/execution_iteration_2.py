...
heur = [
    ...
    (  # Search Operator 2
        ...
        {
            'gravity': 0.0010076340885797834,
            'alpha': 0.007961104670947872,
            'beta': 2.2675067302737193,
            'dt': 1.1115517819355958
        },
        'probabilistic'
    ),
    (  # Search Operator 3
    ...
    (  # Search Operator 4
        'spiral_dynamic',
        {
            'radius': 0.8575938320698979,
            'angle': 23.565664320882508,
            'sigma': 0.058208598067302754
        },
        'random'
    )
]

...
heur = [
    (  # Random Search with Gaussian Distribution and Metropolis Selector
        'random_search',
        {
            'scale': 0.8745788738345096,
            'distribution': 'gaussian'
        },
        'metropolis'
    ),
    (  # Central Force Dynamic with Probabilistic Selector
        'central_force_dynamic',
        {
            'gravity': 0.004314414391199443,
            'alpha': 0.042807165132862625,
            'beta': 2.4180683930474864,
            'dt': 0.866253939421725
        },
        'probabilistic'
    ),
    (  # Differential Mutation with Best Expression and All Selector
        'differential_mutation',
        {
            'expression': 'current',
            'num_rands': 2,
            'factor': 1.6285379535586215
        },
        'all'
    ),
    (  # Firefly Dynamic with Gaussian Distribution and Metropolis Selector
        'firefly_dynamic',
        {
            'distribution': 'gaussian',
            'alpha': 0.9,
            'beta': 1.2,
            'gamma': 82.45511858410268
        },
        'metropolis'
    )
]

# Parámetros de problema y ejecución
problem_id = 1
instance = 1
dimension = 30
num_agents = 50

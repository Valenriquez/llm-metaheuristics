...
def objective(trial):
    heur = [
        ('random_flight',
         {
             ...
             'beta': trial.suggest_float('beta', 1.2, 4.5)
         },
         'metropolis'
        ),
        ...
        ('gravitational_search',
         {
             'gravity': trial.suggest_float('gravity', 0.8, 1.2),
        ...
        ('central_force_dynamic',
         {
             'gravity': trial.suggest_float('gravity', 0.001, 0.002),
             'alpha': trial.suggest_float('alpha', 0.01, 0.03),
             'beta': trial.suggest_float('beta', 1.4, 1.8),
             'dt': trial.suggest_float('dt', 0.7, 1.0)
         },
         'all'
        ),
    ]

...
def objective(trial):
    heur = [
        ...
        ('gravitational_search', {'gravity': trial.suggest_float('gravity', 0.1, 1.0), 'alpha': trial.suggest_float('alpha', 0.01, 0.1)}, 'probabilistic'),
        ('firefly_dynamic', {'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian', 'levy']), 'alpha': trial.suggest_float('alpha', 0.5, 2.0), 'beta': trial.suggest_float('beta', 1.0, 3.0), 'gamma': trial.suggest_float('gamma', 10.0, 100.0)}, 'all'),
        ('swarm_dynamic', {'factor': trial.suggest_float('factor', 0.5, 1.0), 'self_conf': trial.suggest_float('self_conf', 1.0, 3.0), 'swarm_conf': trial.suggest_float('swarm_conf', 1.0, 3.0), 'version': trial.suggest_categorical('version', ['inertial', 'constriction']), 'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian', 'levy'])}, 'greedy')
    ]

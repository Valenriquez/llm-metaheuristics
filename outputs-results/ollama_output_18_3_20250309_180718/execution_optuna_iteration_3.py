...
def objective(trial):
    ...
    ('central_force_dynamic',
        {
            'gravity': trial.suggest_float('gravity', 0.001, 0.02),
    ...
    ('firefly_dynamic',
        {
            ...
            'gamma': trial.suggest_float('gamma', 100.0, 150.0)
        },
        'metropolis'
    ),
    ('genetic_crossover',
        {
            ...
            'mating_pool_factor': trial.suggest_float('mating_pool_factor', 0.2, 0.4)
        },
        'probabilistic'
    ),
    ]

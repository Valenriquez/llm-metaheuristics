...
heur = [
    ...
    (
        ...
        {
            'gravity': 0.0051621373429924814,
            'alpha': 0.02705868205406755,
            'beta': 1.5648614841904873,
            'dt': 1.2826402851072907
        },
        'probabilistic'
    ),
    (
...
# Obtener y comparar con el valor esperado
expected_value = 10.5  # Example expected value
if performance_metric == expected_value:

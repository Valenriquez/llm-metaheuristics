...
heur = [
    ("random_search", 
     {'scale': 0.02901781302984288, 'distribution': 'gaussian'}, 
     "metropolis"),
    ("central_force_dynamic", 
     {'gravity': 0.017757801069374857, 'alpha': 0.03330934032264834, 'beta': 1.8083985449650748, 'dt': 0.20373671199204332}, 
     "probabilistic"),
    ("differential_mutation", 
     {'expression': 'best', 'num_rands': 2, 'factor': 1.7246265356947126}, 
     "greedy"),
    ("firefly_dynamic", 
     {'distribution': 'gaussian', 'alpha': 0.05, 'beta': 0.5, 'gamma': 55}, 
     "all")
]    

        ...
        ('central_force_dynamic',
            {
                ...
                'beta': trial.suggest_float('beta', 1.2, 1.5),
        ...
        ('differential_mutation',
            {
                ...
                'factor': trial.suggest_float('factor', 0.9, 1.5)
            },
            'greedy'
        ),
        ('gravitational_search',
            {
                'gravity': trial.suggest_float('gravity', 0.5, 1.0),
                'alpha': trial.suggest_float('alpha', 0.01, 0.04)
            },
            'all'
        )
    ]

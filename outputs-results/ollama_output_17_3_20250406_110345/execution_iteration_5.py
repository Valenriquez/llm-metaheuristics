...
heur = [
    ('random_search', 
     {'scale': 0.014336377739035937, 'distribution': 'levy'}, 
     'metropolis'),
    ('central_force_dynamic', 
     {'gravity': 0.428420201934679, 'alpha': 0.02029211496707706, 'beta': 3.502905424349378}, 
     'probabilistic'),
    ('differential_mutation', 
     {'expression': 'rand', 'num_rands': 1, 'factor': 0.8715335813329989}, 
     'greedy'),
    ('swarm_dynamic', 
     {'factor': 0.7, 'self_conf': 2.83084607781423, 'swarm_conf': 2.14021924916607, 'version': 'constriction'}, 
     'all')
]    

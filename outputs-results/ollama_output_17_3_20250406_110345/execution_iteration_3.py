...
heur = [
    ('random_search', 
     {'scale': 0.016367268711476327, 'distribution': 'uniform'}, 
     'metropolis'
    ),
    ('gravitational_search', 
     {'gravity': 0.6748634119680048, 'alpha': 0.06605213725198816}, 
     'greedy'
    ),
    ('firefly_dynamic', 
     {'distribution': 'gaussian', 'alpha': 1.5, 'beta': 1.2, 'gamma': 46.0}, 
     'probabilistic'
    ),
    ('swarm_dynamic', 
     {'factor': 0.9122093625997632, 'self_conf': 2.699053744748541, 'swarm_conf': 2.5529465704503416, 'version': 'constriction', 'distribution': 'uniform'}, 
     'all'
    )
]    

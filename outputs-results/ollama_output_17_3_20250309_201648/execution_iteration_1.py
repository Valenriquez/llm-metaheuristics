...
heur = [
    ('random_search', 
        {'scale': 0.049694108188744424, 'distribution': 'levy'},
        'metropolis'),
    ('central_force_dynamic',
        {'gravity': 0.019482458652950927, 'alpha': 0.012758760415851327, 'beta': 1.3216866426295015, 'dt': 0.8305507018519102},
        'probabilistic'),
    ('differential_mutation',
        {'expression': 'current-to-best', 'num_rands': 2, 'factor': 0.9858964309347402},
        'all'),
    ('gravitational_search',
        {'gravity': 1.5, 'alpha': 0.018},
        'greedy')
]    

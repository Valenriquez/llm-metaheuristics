...
def objective(trial):
    heur = [
        ...
        ('central_force_dynamic',
            {'gravity': trial.suggest_float('gravity', 0.001, 0.02), 'alpha': trial.suggest_float('alpha', 0.01, 0.02), 'beta': trial.suggest_float('beta', 1.2, 1.4), 'dt': trial.suggest_float('dt', 0.75, 0.9)},
            'probabilistic'),
        ('differential_mutation',
            {'expression': trial.suggest_categorical('expression', ['rand-to-best', 'current-to-best', 'rand-to-best-and-current']), 'num_rands': 2, 'factor': trial.suggest_float('factor', 0.8, 1.0)},
            'all'),
        ('gravitational_search',
            {'gravity': trial.suggest_float('gravity', 1.3, 1.6), 'alpha': trial.suggest_float('alpha', 0.015, 0.02)},
            'greedy')
    ]

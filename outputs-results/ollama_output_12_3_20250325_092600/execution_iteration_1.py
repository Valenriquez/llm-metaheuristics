...
heur = [
    ('random_search', 
        {'scale': 0.128886083850094}, 
        'metropolis'
    ),
    ('central_force_dynamic', 
        {'gravity': 0.013681020266395234, 'alpha': 0.016935786772029608, 'beta': 1.9505246863658896, 'dt': 0.20199808019504956}, 
        'probabilistic'
    ),
    ('differential_mutation', 
        {'expression': 'best', 'num_rands': 3, 'factor': 1.7094518150799758}, 
        'greedy'
    ),
    ('swarm_dynamic', 
        {'factor': 1.7094518150799758, 'self_conf': 2.2758341886750237, 'swarm_conf': 2.6448884529347834, 'version': 'constriction', 'distribution': 'uniform'}, 
        'all'
    )
]    

...
heur = [
    ...
    ('firefly_dynamic', 
     {'distribution': 'uniform', 'alpha': 1.0, 'beta': 1.0, 'gamma': 50.0}, 
     'probabilistic'),
    
    ('gravitational_search', 
     {'gravity': 0.5, 'alpha': 0.02}, 
     'greedy'),
    
    ('swarm_dynamic', 
     {'factor': 1.0, 'self_conf': 2.54, 'swarm_conf': 2.56, 'version': 'inertial', 'distribution': 'gaussian'}, 
     'all')
]    

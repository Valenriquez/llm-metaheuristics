...
def objective(trial):
    heur = [
        ...
        ("central_force_dynamic", 
         {
             "gravity": trial.suggest_float('gravity', 0.005, 0.1), 
             "alpha": trial.suggest_float('alpha', 0.02, 0.2), 
             "beta": trial.suggest_categorical('beta', ['rank', 'cost', 'random']), 
             "dt": trial.suggest_float('dt', 0.5, 1)
         }, 
         "probabilistic"
        ),
        ("differential_mutation", 
         {
             ...
             "num_rands": trial.suggest_int('num_rands', 2, 3), 
             "factor": trial.suggest_float('factor', 1.5, 2)
         }, 
         "greedy"
        ),
        ("gravitational_search", 
         {
             "gravity": trial.suggest_float('gravity', 0.5, 1), 
             "alpha": trial.suggest_float('alpha', 0.03, 0.04)
         }, 
         "all"
        )
    ]

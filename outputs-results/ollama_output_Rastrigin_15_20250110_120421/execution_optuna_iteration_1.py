...
def objective(trial):
    heur = [
        ...
        ('swarm_dynamic',
         {
             ...
             'self_conf': trial.suggest_float('self_conf', 2.54, 3.0),
             'swarm_conf': trial.suggest_float('swarm_conf', 2.56, 3.0),
        ...
        ('local_random_walk',
         {
             'probability': trial.suggest_float('probability', 0.75, 0.95),

...
heur = [
    (  # Spiral Dynamic Operator
        'spiral_dynamic',
        {
            'radius': 0.18631317257062438,
            'angle': 21.47620446260273,
            'sigma': 0.1272009105418758
        },
        'greedy'
    ),
    (  # Swarm Dynamic Operator
        'swarm_dynamic',
        {
            'factor': 0.5061806431763604,
            'self_conf': 2.6956968604393383,
            'swarm_conf': 1.7441532081909934,

...
heur = [
    (  # Random Search with Gaussian Distribution and Probabilistic Selector
        'random_search',
        {
            'scale': 1.0,
    ...
    (  # Firefly Dynamic with Levy Distribution and Metropolis Selector
        'firefly_dynamic',
        {
            'distribution': 'levy',
            'alpha': 1.052496622633426,
            'beta': 2.3662569840110352,
            'gamma': 26
        },
        'metropolis'
    ),
    (  # Genetic Crossover with Rank Pairing and Single Crossover Type
        'genetic_crossover',
        {
            'pairing': 'random',
            'crossover': 'linear_0.5_0.5',
            'mating_pool_factor': 0.2416539730961454
        },
        'greedy'
    ),

...
heur = [
    (
        'random_flight',
        {
            'scale': refined_parameters['scale'],
            'distribution': refined_parameters['distribution'],
            'beta': refined_parameters['beta']
        },
        'greedy'
    ),
    (
        ...
        {
            'gravity': refined_parameters['gravity'],
            'alpha': refined_parameters['alpha'],
            'beta': refined_parameters['beta'],
            'dt': refined_parameters['dt'] * 0.8
        },
        'probabilistic'
    ),
    (
        ...
        {
            'expression': 'best-and-current-to-best',
            'num_rands': 1,
            'factor': refined_parameters['factor'] * 0.9
        },
        'metropolis'
    ),
    (

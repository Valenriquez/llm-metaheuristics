...
heur = [
    ('random_search',
        {
            'scale': 0.09725402062002342,
            'distribution': 'levy'
        },
        'greedy'),
    ('gravitational_search',
        {
            'gravity': 1.024018562084988,
            'alpha': 0.04370942592781661
        },
        'metropolis'),
    ('central_force_dynamic',
        {
            'gravity': 0.002,
            'alpha': 0.015,
            'beta': 1.3794545597525008,
            'dt': 0.7638604020326574
        },
        'probabilistic'),
    ('spiral_dynamic',
        {
            'radius': 0.8795791157533828,
            'angle': 22.691404558087694,
            'sigma': 0.050309523710251526
        },
        'all')
]    
...
optimal_value = -np.inf  # Reemplaza esto con el valor óptimo del problema
if performance_metric > optimal_value:
    print("El resultado es mejor que el valor óptimo.")
else:
    print("El resultado no es mejor que el valor óptimo.")
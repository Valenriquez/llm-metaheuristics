...
heur = [
    ('random_search', 
        {'scale': 0.016701515982026443, 'distribution': 'uniform'}, 
        'probabilistic'
    ),
    ('central_force_dynamic', 
        {'gravity': 0.0057100155008376376, 'alpha': 0.0249813772707604, 'beta': 1.336976043934125}, 
        'greedy'
    ),
    ('firefly_dynamic', 
        {'distribution': 'uniform', 'alpha': 1.2, 'beta': 0.9, 'gamma': 177}, 
        'metropolis'
    ),
    ('genetic_crossover', 
        {'pairing': 'rank', 'crossover': 'uniform', 'mating_pool_factor': 0.22596800733947464}, 
        'all'
    )
]    

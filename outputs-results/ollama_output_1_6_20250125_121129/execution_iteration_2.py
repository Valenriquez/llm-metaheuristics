...
heur = [
    ...
    ('central_force_dynamic',
        {
            'gravity': 0.01364690802402747,
            'alpha': 0.15585409858136529,
            'beta': 1.3011025306280994,
            'dt': 0.5962558506857097
        },
        'probabilistic'
    ),
...
# Nota: Las modificaciones solo afectan los valores en la lista 'heur'.
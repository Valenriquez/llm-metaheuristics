...
def objective(trial):
    heur = [
        ('random_search', {'scale': trial.suggest_float('scale', 0.01, 0.1), 'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian', 'levy'])}, 'greedy'),
        ('central_force_dynamic', {'gravity': trial.suggest_float('gravity', 0.001, 0.01), 'alpha': trial.suggest_float('alpha', 0.01, 0.1), 'beta': trial.suggest_float('beta', 1.5, 4.5), 'dt': trial.suggest_float('dt', 0.5, 2.0)}, 'metropolis'),
        ...
        ('gravitational_search', {'gravity': trial.suggest_float('gravity', 0.1, 1.0), 'alpha': trial.suggest_float('alpha', 0.01, 0.05)}, 'all')
    ]

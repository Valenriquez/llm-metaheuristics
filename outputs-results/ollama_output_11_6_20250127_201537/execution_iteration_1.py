...
heur = [
    ("random_search", 
     {'scale': 0.622422850770964}, 
     "greedy"),
    ("central_force_dynamic", 
     {'gravity': 0.4981107548247929, 'alpha': 1.9908038155327519, 'beta': 1.9903653184783638, 'dt': 14.499068652584544}, 
     "all"),
    ("differential_mutation", 
     {'expression': 'rand-to-best', 'num_rands': 1, 'factor': 0.5329454428590364}, 
     "metropolis"),
    ("firefly_dynamic", 
     {'distribution': 'uniform', 'gamma': 44}, 
     "probabilistic")
]    

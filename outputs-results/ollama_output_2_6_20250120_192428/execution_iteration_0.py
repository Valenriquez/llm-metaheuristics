...
heur = [
    ("random_search", 
     {"scale": 0.025671987341267556}, 
     "metropolis"
    ),
    ("central_force_dynamic",
     {"gravity": 0.0018189478406332431, "alpha": 0.0032502205635053113, "beta": 2.6286715196166375, "dt": 0.6566409080571085}, 
     "probabilistic"
    ),
    ("genetic_crossover", 
     {"pairing": "rank", "crossover": "single", "mating_pool_factor": 0.2582630501416574}, 
     "greedy"
    )
]    

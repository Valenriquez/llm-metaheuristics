...
heur = [
    ("random_search", 
     {'scale': 0.008, 'distribution': "gaussian"}, 
     "metropolis"),
    ("central_force_dynamic", 
     {'gravity': 0.02, 'alpha': 0.015, 'beta': 1.9, 'dt': 0.48}, 
     "probabilistic"),
    ("differential_mutation", 
     {'expression': "current-to-best", 'factor': 0.95}, 
     "all"),
    ("swarm_dynamic", 
     {'factor': 0.7, 'self_conf': 2.54, 'swarm_conf': 2.56, 'distribution': "gaussian"}, 
     "greedy")
]    

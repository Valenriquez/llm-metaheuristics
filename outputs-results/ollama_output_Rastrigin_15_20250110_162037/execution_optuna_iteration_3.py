...
def objective(trial):
    heur = [
        ...
        (
            'swarm_dynamic',
            {
                ...
                'self_conf': trial.suggest_float('self_conf', 1.0, 3.5),
                'swarm_conf': trial.suggest_float('swarm_conf', 1.0, 3.5),
    ...
    performance = evaluate_sequence_performance(heur, prob, num_agents=trial.suggest_int('num_of_agents', 10, 50), num_iterations=100, num_replicas=30)

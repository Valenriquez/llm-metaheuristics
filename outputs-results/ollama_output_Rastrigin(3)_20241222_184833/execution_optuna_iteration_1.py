        ...
        ('central_force_dynamic',
         {
             ...
             'beta': trial.suggest_categorical('beta', ['inertial', 'constriction']),
        ...
        ('swarm_dynamic',
         {
             ...
             'self_conf': trial.suggest_categorical('self_conf', [1.5, 2.54, 3]),
             'swarm_conf': trial.suggest_categorical('swarm_conf', [1.5, 2.56, 3]),

...
def objective(trial):
    heur = [
        ('random_search',  # Search operator 1 - Random Search with Gaussian distribution
         {
        ...
        ('swarm_dynamic',  # Swarm dynamic with Inertial version
         {
             ...
             'self_conf': trial.suggest_float('self_conf', 1.5, 3),
             'swarm_conf': trial.suggest_float('swarm_conf', 1.5, 3),

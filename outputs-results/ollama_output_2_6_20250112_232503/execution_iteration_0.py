...
Make sure to replace `[operator_name]`, `value1`, `value2`, and `[selector_name]` with the actual values from your sequence. Also, ensure that all necessary modules are installed and correctly imported in your environment.
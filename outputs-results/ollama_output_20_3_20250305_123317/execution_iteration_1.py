...
heur = [
    ('central_force_dynamic',
        {
            'gravity': 0.04539270916369119,
            'alpha': 0.18735709996894684,
            'beta': 1.631189347211544,
            'dt': 0.5819392749743161
        },
        'metropolis'
    ),
    ('genetic_crossover',
        {
            'pairing': 'cost',
            'crossover': 'single',
            'mating_pool_factor': 0.37343857464615005
        },
        'all'
    ),
    ('spiral_dynamic',
        {
            'radius': 0.7625111795012253,
            'angle': 19.616089935025208,
            'sigma': 0.129813164235672
        },
        'greedy'
    ),
    ('random_flight',
        {
            'scale': 0.8384424499941182,
            'distribution': 'levy',
            'beta': 1.5
        },
        'probabilistic'

...
def objective(trial):
    heur = [
        ...
        ('spiral_dynamic', {'radius': trial.suggest_float('radius', 0.1, 0.9), 'angle': trial.suggest_float('angle', 15, 25), 'sigma': 0.1}, 'metropolis'),
        ('swarm_dynamic', {
            'factor': trial.suggest_float('factor', 0.3, 0.7),
            'self_conf': trial.suggest_float('self_conf', 1.5, 3),
            'swarm_conf': trial.suggest_float('swarm_conf', 2.1, 3),

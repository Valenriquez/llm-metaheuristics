...
def objective(trial):
    heur = [
        ...
        ('central_force_dynamic', 
         {'gravity': trial.suggest_float('gravity', 0.001, 0.005), 'alpha': trial.suggest_float('alpha', 0.02, 0.08), 'beta': trial.suggest_float('beta', 1.5, 4.5), 'dt': trial.suggest_float('dt', 1.0, 1.5)}, 
         'probabilistic'),
        ('differential_mutation', 
         {'expression': trial.suggest_categorical('expression', ['rand', 'best', 'current', 'current-to-best', 'rand-to-best', 'rand-to-best-and-current']), 'num_rands': trial.suggest_int('num_rands', 1, 3), 'factor': trial.suggest_float('factor', 0.8, 1.5)}, 
         'greedy'),
        ('spiral_dynamic', 
         {'radius': trial.suggest_float('radius', 0.7, 0.9), 'angle': trial.suggest_float('angle', 20, 30), 'sigma': trial.suggest_float('sigma', 0.1, 0.2)}, 
         'all'),
    ]

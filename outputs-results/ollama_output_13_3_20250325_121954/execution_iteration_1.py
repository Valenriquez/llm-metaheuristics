...
heur = [
    ('random_search', 
     {'scale': 0.008170842221387326, 'distribution': 'uniform'}, 
     'metropolis'),
    ('central_force_dynamic', 
     {'gravity': 0.002028475895116371, 'alpha': 0.035003006879150006, 'beta': 2.180522937361825, 'dt': 1.1893363687381333}, 
     'probabilistic'),
    ('differential_mutation', 
     {'expression': 'rand-to-best', 'num_rands': 2, 'factor': 1.3295672270701298}, 
     'greedy'),
    ('spiral_dynamic', 
     {'radius': 0.8091292036650937, 'angle': 22.114462060223655, 'sigma': 0.19774099395112468}, 
     'all')
]    

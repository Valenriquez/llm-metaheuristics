        ...
        ('swarm_dynamic',
         {
             ...
             'self_conf': trial.suggest_categorical('self_conf', [2.5, 2.6, 2.7]),
             'swarm_conf': trial.suggest_categorical('swarm_conf', [2.5, 2.6, 2.7]),
        ...
        ('spiral_dynamic',
         {
             ...
             'angle': trial.suggest_categorical('angle', [25]),

...
heur = [  
    ('random_search', {'scale': 0.037324842341865457, 'distribution': 'uniform'}, 'metropolis'),  
    ('central_force_dynamic', {'gravity': 0.0030700686568785884, 'alpha': 0.018932934064901995, 'beta': 3.237701802557194, 'dt': 1.0772365169762832}, 'probabilistic'),  
    ('genetic_crossover', {'pairing': 'random', 'crossover': 'blend', 'mating_pool_factor': 0.4911678909679116}, 'greedy'),  
    ('spiral_dynamic', {'radius': 0.8772677900541925, 'angle': 24.138204467378714, 'sigma': 0.10669487937588622}, 'all')  
]  

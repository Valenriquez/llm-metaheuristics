...
heur = [
    ('random_search', 
     {'scale': 0.1, 'distribution': 'gaussian'}, 
     'metropolis'
    ),
    ('central_force_dynamic', 
     {'gravity': 0.01, 'alpha': 0.1, 'beta': 2.0, 'dt': 0.5}, 
     'probabilistic'
    ),
    ('differential_mutation', 
     {'expression': 'rand-to-best-and-current', 'num_rands': 2, 'factor': 1.5}, 
     'greedy'
    ),
    ('swarm_dynamic', 
     {'factor': 0.75, 'self_conf': 2.6, 'swarm_conf': 2.58, 'version': 'inertial', 'distribution': 'levy'}, 
     'all'
    )
]    

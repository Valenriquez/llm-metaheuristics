        ...
        ('central_force_dynamic',
         {
             ...
             'alpha': trial.suggest_float('alpha', 0.015, 0.02),
             'beta': trial.suggest_float('beta', 1.5, 4.5),
             'dt': trial.suggest_float('dt', 0.96, 1.0)
         },
         'probabilistic'
         ),
        ...
        ('differential_mutation',
         {
             ...
             'factor': trial.suggest_float('factor', 0.95, 1.2)
         },
         'metropolis'
         ),
        ...
        ('spiral_dynamic',
         {
             ...
             'sigma': trial.suggest_float('sigma', 0.1, 0.17)
         },
         'constriction'
         ),
    ]

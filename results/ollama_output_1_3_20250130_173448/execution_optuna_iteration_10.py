...
def objective(trial):
    heur = [
        ...
        ("gravitational_search", 
         {'gravity': trial.suggest_float('gravity', 0.002, 0.006), 'alpha': trial.suggest_float('alpha', 0.01, 0.03)}, 
         "metropolis"
        ),
        ("central_force_dynamic", 
         {'gravity': trial.suggest_float('gravity', 0.0005, 0.002), 'alpha': trial.suggest_float('alpha', 0.015, 0.025), 'beta': trial.suggest_float('beta', 1.8, 2.2), 'dt': trial.suggest_float('dt', 0.7, 0.8)}, 
         "probabilistic"
        ),
        ("spiral_dynamic", 

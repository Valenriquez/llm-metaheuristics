...
heur = [
    ...
    (  # Search Operator 2
        'swarm_dynamic',
        {
            'factor': 0.561069115388012,
            'self_conf': 2.6973628820300117,
            'swarm_conf': 2.3372082587889067,
    ...
    (  # Search Operator 4
        ...
        {
            'gravity': 0.008763468373306858,
            'alpha': 0.017271485518603295
        },
        'constriction'
    )
]

# This is the Python Iteration: 10
# Author: [Your Name]
# Date: [Insert Date]
...
heur = [
    ...
    ("gravitational_search", 
        {'gravity': 0.004, 'alpha': 0.02}, 
        "metropolis"
    ),
    ("central_force_dynamic", 
        {'gravity': 0.001, 'alpha': 0.018, 'beta': 1.9, 'dt': 0.78}, 
        "probabilistic"
    ),
    ("spiral_dynamic", 
...
parameters = {
    "random_search": {'scale': 0.00492088130379155},
    "gravitational_search": {'gravity': 0.0036983313304595985, 'alpha': 0.028832515562529318},
    "central_force_dynamic": {'gravity': 0.001, 'alpha': 0.018, 'beta': 1.9434739310357447, 'dt': 0.7392862307452966},
    "spiral_dynamic": {'radius': 0.8045134865180142, 'angle': 22.525367302192315, 'sigma': 0.13660118191207427}
}

heur = [(heur[0], {**heur[1], **parameters.get(heur[0], {})}, heur[2]) for heur in heur]

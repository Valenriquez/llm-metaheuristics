...
heur = [
    ...
    (  # Search Operator 2
        ...
        {
            'gravity': 0.002504033334942737,
            'alpha': 0.0192365794565389,
            'beta': 3.559122220576683,
            'dt': 0.9996772849713008
        },
        'probabilistic'
    ),
    (  # Search Operator 3
    ...
    (  # Search Operator 4
        'spiral_dynamic',
        {
            'radius': 0.8138167693713433,
            'angle': 22.569561670037004,
            'sigma': 0.16997575432971612
        },
        'dynamic'
    )
]

...
heur = [
    ...
    ('central_force_dynamic', {'gravity': 0.001, 'alpha': 0.01, 'beta': 1.5, 'dt': 1.0}, 'probabilistic'),
    ('differential_mutation', {'expression': 'rand-to-best-and-current', 'num_rands': 2, 'factor': 1.5}, 'all'),
    ('gravitational_search', {'gravity': 0.5, 'alpha': 0.03}, 'greedy')
]    

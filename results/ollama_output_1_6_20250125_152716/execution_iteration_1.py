...
heur = [
    ...
    (  # Search Operator 2
        ...
        {
            'gravity': 0.0011266339029040852,
            'alpha': 0.0027269892402161386,
            'beta': 2.17119437639294,
            'dt': 0.6700639127595184
        },
        'probabilistic'
    ),
    (  # Search Operator 3
    ...
    (  # Search Operator 4
        'spiral_dynamic',
        {
            'radius': 0.8457188889743608,
            'angle': 21.796374976636987,
            'sigma': 0.11680777746647802
        },
        'dynamic'
    )
]

...
heur = [
    ('random_search', 
        {
            'scale': 0.06143308927491645
        }, 
        'probabilistic'
    ),
    ('swarm_dynamic', 
        {
            'factor': 0.7634773654068612, 
            'self_conf': 2.3398567016294476, 
            'swarm_conf': 2.1460466944955727, 
    ...
    ('spiral_dynamic', 
        {
            'radius': 0.8199274160000825, 
            'angle': 24.46161789850321, 
            'sigma': 0.14269812110284183
        }, 
        'probabilistic'
    ),
    ('random_sample', 

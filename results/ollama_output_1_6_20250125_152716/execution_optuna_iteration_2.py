...
def objective(trial):
    heur = [
        ...
        ('central_force_dynamic', {'gravity': trial.suggest_float('gravity', 0.001, 0.01), 'alpha': trial.suggest_float('alpha', 0.01, 0.05), 'beta': trial.suggest_float('beta', 1.3, 2.5), 'dt': trial.suggest_float('dt', 0.5, 1.0)}, 'probabilistic'),
        ('differential_mutation', {'expression': trial.suggest_categorical('expression', ['rand', 'best', 'current']), 'num_rands': trial.suggest_int('num_rands', 1, 5), 'factor': trial.suggest_float('factor', 1.0, 2.0)}, 'all'),
        ('firefly_dynamic', {'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian', 'levy']), 'alpha': trial.suggest_float('alpha', 0.8, 1.0), 'beta': trial.suggest_float('beta', 1.1, 1.5), 'gamma': trial.suggest_float('gamma', 70.0, 90.0)}, 'metropolis'),
    ]

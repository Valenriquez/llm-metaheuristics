...
heur = [
    (  # Search Operator 1: Random Flight
        'random_flight',
        {
            'scale': 0.5172163915637648,
            'distribution': 'gaussian',
            'beta': 3.742778532140721
        },
        'metropolis'
    ),
    ...
    (  # Search Operator 3: Gravitational Search
        ...
        {
            'gravity': 0.9337127401256772,
            'alpha': 0.013766949675943914
        },
        'probabilistic'
    ),
    (  # Search Operator 4: Central Force Dynamic
        'central_force_dynamic',
        {
            'gravity': 0.0015,
            'alpha': 0.012,
            'beta': 1.6,
            'dt': 0.8534531465718619
        },
        'all'
    )
]    

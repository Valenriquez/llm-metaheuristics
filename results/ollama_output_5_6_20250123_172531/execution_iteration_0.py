...
heur = [
    ...
    (  # Search Operator 2
        ...
        {
            'gravity': 0.2759762660019394,
            'alpha': 0.06985716738301248,
            'beta': 1.6304098200097665,
            'dt': 0.6472712482823408
        },
        'probabilistic'
    ),
    (  # Search Operator 3
...
# Continue with the next iteration or end the script as needed.
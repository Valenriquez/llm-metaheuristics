...
heur = [
    ('central_force_dynamic', 
     {'gravity': 0.0020102755638147863, 'alpha': 0.003593010418075932, 'beta': 2.6422231474134703, 'dt': 0.6407873799778656}, 
     'metropolis'
    ),
    ('genetic_crossover', 
     {'pairing': 'rank', 'crossover': 'blend', 'mating_pool_factor': 0.4127694198354327}, 
     'probabilistic'
    ),
    ('differential_mutation', 
     {'expression': 'rand-to-best-and-current', 'num_rands': 1, 'factor': 0.5907631160758957}, 
     'greedy'
    ),
    ('spiral_dynamic', 
     {'radius': 0.8047060470141416, 'angle': 20.003615907530154, 'sigma': 0.025785655851350307}, 
     'all'
    )
]    

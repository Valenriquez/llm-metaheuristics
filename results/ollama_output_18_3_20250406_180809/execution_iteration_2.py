...
heur = [
    ...
    (  # Central Force Dynamic Operator
        ...
        {
            'gravity': 0.009158205171131726,
            'alpha': 0.06010835668800288,
            'beta': 2.7519186176665817,
            'dt': 0.9592322875049416
        },
        'probabilistic'
    ),
    (  # Differential Mutation Operator
        'differential_mutation',
        {
            'expression': 'rand',
            'num_rands': 1,
            'factor': 0.9783187199049552
        },
        'metropolis'
    ),
    (  # Firefly Dynamic Operator
        'firefly_dynamic',
        {
            'distribution': 'uniform',
            'alpha': 1.0,
            'beta': 1.0,
            'gamma': 69.37176257798907
        },
        'all'
    )
]    

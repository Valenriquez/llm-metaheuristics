...
heur = [
    ('random_search',
        {
            'scale': 0.05484827771461282,
            'distribution': 'gaussian'
        },
        'probabilistic'),
    ('central_force_dynamic',
        {
            'gravity': 0.07072248929085206,
            'alpha': 0.06245699844231352,
            'beta': 1.7978075646504261,
            'dt': 0.25249112391966644
        },
        'greedy'),
    ('differential_mutation',
        {
            'expression': 'rand',
            'num_rands': 2,
            'factor': 0.7243375040316435
        },
        'metropolis'),
    ('swarm_dynamic',
        {
            'factor': 0.9,
            'self_conf': 2.818648834636816,
            'swarm_conf': 2.593779615165889,

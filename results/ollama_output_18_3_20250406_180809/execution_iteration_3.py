...
heur = [
    ...
    (  # Central Force Dynamic Operator
        ...
        {
            'gravity': 0.011031865215874764,
            'alpha': 0.024352395929245887,
            'beta': 1.5301156816687937,
            'dt': 0.38013153550026063
        },
        'metropolis'
    ),
...
# No further modifications are made to the code.
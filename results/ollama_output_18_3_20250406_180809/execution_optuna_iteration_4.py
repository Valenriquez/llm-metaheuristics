...
def objective(trial):
    heur = [
        ...
        ('firefly_dynamic',
         {
             ...
             'gamma': trial.suggest_float('gamma', 10.0, 15.0)
         },
         'metropolis'
        ),
        ...
        ('swarm_dynamic',
         {
             ...
             'swarm_conf': trial.suggest_float('swarm_conf', 1.5, 2.5),
        ...
        ('random_search',
         {
             'scale': trial.suggest_float('scale', 0.02, 0.1),
             'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian', 'levy'])
         },
         'greedy'
        ),
        ...
        ('central_force_dynamic',
         {
             'gravity': trial.suggest_float('gravity', 0.05, 0.07),
             'alpha': trial.suggest_float('alpha', 0.06, 0.08),
             'beta': trial.suggest_float('beta', 1.7, 2.1),
             'dt': trial.suggest_float('dt', 0.2, 0.3)
         },
         'all'
        ),
    ]

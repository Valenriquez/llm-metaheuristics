...
def objective(trial):
    heur = [
        ('random_search', 
         {'scale': trial.suggest_float('scale', 0.01, 0.02), 'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian', 'levy'])}, 
         'metropolis'),
        ('central_force_dynamic', 
         {'gravity': trial.suggest_float('gravity', 0.3, 0.5), 'alpha': trial.suggest_float('alpha', 0.01, 0.2), 'beta': trial.suggest_float('beta', 2.0, 4.0)}, 
         'probabilistic'),
        ('differential_mutation', 
         {'expression': trial.suggest_categorical('expression', ['rand', 'best', 'current']), 'num_rands': 1, 'factor': trial.suggest_float('factor', 0.8, 0.95)}, 
         'greedy'),
        ('swarm_dynamic', 
         {'factor': trial.suggest_float('factor', 0.6, 0.8), 'self_conf': trial.suggest_float('self_conf', 2.0, 3.0), 'swarm_conf': trial.suggest_float('swarm_conf', 1.5, 3.0), 'version': trial.suggest_categorical('version', ['inertial', 'constriction'])}, 
         'all'),
    ]

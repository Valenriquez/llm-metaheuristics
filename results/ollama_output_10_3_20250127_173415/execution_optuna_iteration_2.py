...
def objective(trial):
    heur = [
        ...
        ('central_force_dynamic', {'gravity': trial.suggest_float('gravity', 0.001, 0.01), 'alpha': trial.suggest_float('alpha', 0.01, 0.05), 'beta': trial.suggest_float('beta', 1.2, 1.8), 'dt': trial.suggest_float('dt', 0.8, 1.0)}, 'probabilistic'),
        ('differential_mutation', {'expression': trial.suggest_categorical('expression', ['rand', 'best', 'current-to-best', 'rand-to-best', 'rand-to-best-and-current']), 'num_rands': 2, 'factor': trial.suggest_float('factor', 1.0, 1.5)}, 'greedy'),
        ('gravitational_search', {'gravity': trial.suggest_float('gravity', 0.7, 1.0), 'alpha': trial.suggest_float('alpha', 0.01, 0.02)}, 'all')
    ]

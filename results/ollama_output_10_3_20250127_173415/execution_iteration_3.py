...
heur = [
    ('random_search',
        {
            'scale': 0.009469400724123216,
            'distribution': 'gaussian'
        },
        'metropolis'),
    ('central_force_dynamic',
        {
            'gravity': 0.04542207309449296,
            'alpha': 0.021723061278932792,
            'beta': 1.2401855359890803,
            'dt': 0.7856006262240214
        },
        'probabilistic'),
    ('firefly_dynamic',
        {
            ...
            'alpha': 1.0,
            'beta': 1.0,
            'gamma': 44.80877303815982
        },
        'greedy'),
    ('spiral_dynamic',
        {
            'radius': 0.7102276123669219,
            'angle': 16.16221072850317,
            'sigma': 0.06241868210803551
        },
        'all')
]    

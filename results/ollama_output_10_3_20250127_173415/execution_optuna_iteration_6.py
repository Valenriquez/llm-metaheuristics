...
def objective(trial):
    heur = [
        (
            ...
            trial.suggest_categorical('version', ['inertial', 'constriction'])
        ),
        (
        ...
        (
            ...
            'random_sample',
            {},
            trial.suggest_categorical('strategy', ['greedy', 'random', 'tournament'])
        ),
        (
...
print("Mejor rendimiento encontrado:", study.best_value)
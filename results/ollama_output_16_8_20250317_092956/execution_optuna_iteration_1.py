...
def objective(trial):
    heur = [
        ("random_search", 
         {'scale': trial.suggest_float('scale', 0.005, 0.02), 'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian', 'levy'])}, 
         "metropolis"),
        ("central_force_dynamic", 
         {'gravity': trial.suggest_float('gravity', 0.001, 0.01), 'alpha': trial.suggest_float('alpha', 0.01, 0.03), 'beta': trial.suggest_float('beta', 1.2, 1.6), 'dt': trial.suggest_float('dt', 0.5, 1.5)}, 
         "probabilistic"),
        ("differential_mutation", 
         {'expression': trial.suggest_categorical('expression', ['rand', 'best', 'current', 'current-to-best', 'rand-to-best', 'rand-to-best-and-current']), 'num_rands': 2, 'factor': trial.suggest_float('factor', 1.0, 2.0)}, 
         "greedy"),
        ("spiral_dynamic", 
         {'radius': trial.suggest_float('radius', 0.7, 0.9), 'angle': trial.suggest_float('angle', 15.0, 25.0), 'sigma': trial.suggest_float('sigma', 0.1, 0.2)}, 
         "all"),
    ]

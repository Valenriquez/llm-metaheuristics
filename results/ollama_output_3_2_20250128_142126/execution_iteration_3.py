...
heur = [
    ("random_search", 
        {
            "scale": 0.015239016264001537, 
            "distribution": 'uniform'
        }, 
        "probabilistic"),
    ("central_force_dynamic",
        {
            "gravity": 0.007680535025739173,
            "alpha": 0.012182523089517497,
            "beta": 1.8416547073043623,
            "dt": 0.25073133368249095
        },
        "greedy"),
    ("differential_mutation", 
        {
            "expression": 'best',
            "num_rands": 1,
            "factor": 0.8965535896779521
        },
        "metropolis"),
    ("spiral_dynamic",
        {
            "radius": 0.7586592543430845,
            "angle": 19.312372005730918,
            "sigma": 0.2514415378264785
        },
        "all")
]    

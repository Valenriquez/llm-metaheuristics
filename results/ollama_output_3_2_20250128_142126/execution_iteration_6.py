...
heur = [
    (  # Swarm Dynamic Operator
        'swarm_dynamic',
        {
            'factor': 0.7928731819916879,
            'self_conf': 2.209422371591902,
            'swarm_conf': 2.603519942785916,
    ...
    (  # Spiral Dynamic Operator
        'spiral_dynamic',
        {
            'radius': 0.6035559491614275,
            'angle': 23.34486079009237,
            'sigma': 0.12800050654478196
        },
        'metropolis'
    )
]    

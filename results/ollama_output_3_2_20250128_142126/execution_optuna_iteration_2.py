...
def objective(trial):
    ...
    ('central_force_dynamic', 
        {'gravity': trial.suggest_float('gravity', 0.001, 0.01), 'alpha': trial.suggest_float('alpha', 0.01, 0.05), 'beta': trial.suggest_float('beta', 1.2, 1.4)}, 
        'probabilistic'
    ),
    ('genetic_crossover', 
    ...
    performance = evaluate_sequence_performance(heur, prob, num_agents=41, num_iterations=100, num_replicas=30)

...
heur = [
    (
        'swarm_dynamic',
        {
            'factor': 0.8891016605753432,
            'self_conf': 2.9510556444903253,
            'swarm_conf': 2.808107219108844,
    ...
    (
        'spiral_dynamic',
        {
            'radius': 0.5461020348502388,
            'angle': 22.475742471496766,
            'sigma': 0.19129981971016588
        },
        'random_sample'
    )
]    

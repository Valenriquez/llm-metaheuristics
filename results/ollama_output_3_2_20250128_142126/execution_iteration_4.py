...
heur = [
    (  # Search Operator 1
        'swarm_dynamic',
        {
            'factor': 0.85263894023897,
            'self_conf': 2.4793755145556746,
            'swarm_conf': 2.8827842729200146,
    ...
    (  # Search Operator 2
        'spiral_dynamic',
        {
            'radius': 0.5292626419168088,
            'angle': 16.12537388664319,
            'sigma': 0.1400965388331486
        },
        'probabilistic'
    )
]    

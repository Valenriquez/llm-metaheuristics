...
heur = [
    ('random_search', 
     {'scale': 0.04887185491357547, 'distribution': 'levy'}, 
     'metropolis'
    ),
    ('central_force_dynamic', 
     {'gravity': 0.0031476923995743616, 'alpha': 0.016735503967681316, 'beta': 2.6402249488534637, 'dt': 0.8947741393040778}, 
     'greedy'
    ),
    ('genetic_crossover', 
     {'pairing': 'cost', 'crossover': 'linear_0.5_0.5', 'mating_pool_factor': 0.340859649232278}, 
     'probabilistic'
    ),
    ('spiral_dynamic', 
     {'radius': 0.798928878605632, 'angle': 20.63655487316466, 'sigma': 0.11816819249892599}, 
     'all'
    )
]    

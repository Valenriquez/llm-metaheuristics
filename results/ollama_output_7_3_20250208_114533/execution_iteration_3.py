...
heur = [
    ...
    (  # Search Operator 2
        ...
        {
            'gravity': 0.006013238197584584,
            'alpha': 0.044862320990539786,
            'beta': 1.3839632328142604,
            'dt': 1.874870374790695
        },
        'probabilistic'
    ),
    (  # Search Operator 3
...
# No modifications to the given parameters are made.
...
def objective(trial):
    heur = [
        ('random_search',
         {
             'scale': trial.suggest_float('scale', 0.1, 0.2),
        ...
        ('central_force_dynamic',
         {
             'gravity': trial.suggest_float('gravity', 0.01, 0.03),
             'alpha': trial.suggest_float('alpha', 0.02, 0.04),
             'beta': trial.suggest_float('beta', 1.5, 2.5),
        ...
        ('firefly_dynamic',
         {
             ...
             'gamma': trial.suggest_float('gamma', 200.0, 400.0)
         },
         'greedy'),
        ...
        ('spiral_dynamic',
         {
             ...
             'angle': trial.suggest_float('angle', 21.0, 25.0),
             'sigma': trial.suggest_float('sigma', 0.03, 0.06)
         },
         'all'),
    ]

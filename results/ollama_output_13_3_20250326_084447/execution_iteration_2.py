...
heur = [
    ('random_search', 
     {'scale': 0.05677860949280125, 'distribution': 'uniform'}, 
     'metropolis'),
    ('central_force_dynamic', 
     {'gravity': 0.033557665466739356, 'alpha': 0.03179312765314386, 'beta': 1.2046285151140055, 'dt': 0.2720099007334479}, 
     'probabilistic'),
    ('differential_mutation', 
     {'expression': 'current-to-best', 'num_rands': 2, 'factor': 1.6731354599544723}, 
     'greedy'),
    ('spiral_dynamic', 
     {'radius': 0.8751909357435119, 'angle': 25.583804706348218, 'sigma': 0.05283939643080256}, 
     'all')
]    

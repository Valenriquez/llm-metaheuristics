...
def objective(trial):
    heur = [
        ('random_search', 
         {'scale': trial.suggest_float('scale', 0.01, 0.2), 'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian'])}, 
         'metropolis'),
        ('central_force_dynamic', 
         {'gravity': trial.suggest_float('gravity', 0.03, 0.08), 'alpha': trial.suggest_float('alpha', 0.01, 0.05), 'beta': trial.suggest_float('beta', 1.2, 2.4), 'dt': trial.suggest_float('dt', 0.2, 0.6)}, 
         'probabilistic'),
        ('differential_mutation', 
         {'expression': trial.suggest_categorical('expression', ['rand', 'best', 'current-to-best']), 'num_rands': 2, 'factor': trial.suggest_float('factor', 1.3, 1.8)}, 
         'greedy'),
        ('spiral_dynamic', 
         {'radius': trial.suggest_float('radius', 0.7, 0.9), 'angle': trial.suggest_float('angle', 25.0, 26.0), 'sigma': trial.suggest_float('sigma', 0.03, 0.08)}, 
         'all'),
    ]

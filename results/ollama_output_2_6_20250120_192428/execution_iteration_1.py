...
heur = [
    ...
    (
        ...
        {
            'gravity': 0.0011971805782924688,
            'alpha': 0.08162068079350177,
            'beta': 1.6007479776234939,
            'dt': 0.644661631300678
        },
        'probabilistic'
    ),
    (
        'genetic_crossover',
        {
            'pairing': 'random',
            'crossover': 'two',
            'mating_pool_factor': 0.4983494710069164
        },
        'all'
    )
]    

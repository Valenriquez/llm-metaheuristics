...
heur = [
    ...
    (  # Search Operator 2
        ...
        {
            'gravity': 0.004800658816486142,
            'alpha': 0.03319701283301202,
            'beta': 3.6599530771554853,
            'dt': 1.1617082780319843
        },
        'metropolis'
    ),
    (  # Search Operator 3
...
# Evaluate the solution against the known optimal value
known_optimal_value = 0.0  # Replace with the actual known optimal value for problem_id and instance
solution_quality = performance_metric / known_optimal_value if known_optimal_value != 0 else None

print("Calidad de la solución:", solution_quality)
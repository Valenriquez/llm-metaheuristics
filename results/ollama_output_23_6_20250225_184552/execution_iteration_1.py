...
# Update the parameters for each operator as specified
heur[0][1]['scale'] = 0.0065192383634303675
heur[0][1]['distribution'] = 'levy'
heur[1][1]['gravity'] = 0.0032258925292653383
heur[1][1]['alpha'] = 0.023010379641343823
heur[1][1]['beta'] = 1.3275560468646064
heur[1][1]['dt'] = 0.9002226485950062
heur[2][1]['expression'] = 'current-to-best'
heur[2][1]['num_rands'] = 2
heur[2][1]['factor'] = 0.829900924409521

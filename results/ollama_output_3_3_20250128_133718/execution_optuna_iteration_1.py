        ...
        ('central_force_dynamic',
            {
                ...
                'dt': trial.suggest_float('dt', 1, 2)
            }, 
            'probabilistic'),
        ('differential_mutation', 
            {
                'expression': trial.suggest_categorical('expression', ['rand', 'best', 'current-to-best', 'rand-to-best-and-current']), 
                'num_rands': trial.suggest_int('num_rands', 1, 5), 
                'factor': trial.suggest_float('factor', 0.8, 1.2)
            }, 
            'greedy'),
        ('gravitational_search',
            {
                'gravity': trial.suggest_float('gravity', 1, 2), 

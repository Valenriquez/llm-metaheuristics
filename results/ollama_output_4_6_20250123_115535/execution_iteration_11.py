# This is the Python Iteration: 12
...
heur = [
    ('random_search', 
     {'scale': 0.03571480109135284, 'distribution': 'uniform'}, 
     'metropolis'),
    ('firefly_dynamic', 
     {'distribution': 'uniform', 'alpha': 0.10713035317407762, 'beta': 1.8949689834547572, 'gamma': 96}, 
     'probabilistic'),
    ('gravitational_search', 
     {'gravity': 0.06979550636830914, 'alpha': 0.025}, 
     'greedy'),
    ('swarm_dynamic', 
     {'factor': 0.7332138328985318, 'self_conf': 2.5250105914786167, 'swarm_conf': 2.549309878842964, 'version': 'constriction', 'distribution': 'uniform'}, 
     'all')
]    

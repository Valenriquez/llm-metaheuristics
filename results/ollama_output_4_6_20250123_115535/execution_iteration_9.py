...
heur = [
    (  # Search operator 1
        ...
        {
            'gravity': 0.026029417376350554,
            'alpha': 0.07562601940568602,
            'beta': 1.9630029284780828,
            'dt': 0.7839333424076265
        },
        'metropolis'
    ),
    (
    ...
    (
        'spiral_dynamic',
        {
            'radius': 0.8327548328832713,
            'angle': 22.350320449787045,
            'sigma': 0.12274462600162019
        },
        'simple'
    )
]

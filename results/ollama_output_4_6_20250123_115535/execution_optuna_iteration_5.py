...
def objective(trial):
    heur = [
        ...
        ("central_force_dynamic",
         {'gravity': trial.suggest_float('gravity', 0.03, 0.07), 'alpha': trial.suggest_float('alpha', 0.1, 0.5), 'beta': trial.suggest_float('beta', 1.5, 2.5), 'dt': trial.suggest_float('dt', 0.8, 1.2)}, 
         "greedy"),
        ("firefly_dynamic", 
         {'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian','levy']), 'alpha': trial.suggest_float('alpha', 0.7, 1.1), 'beta': trial.suggest_float('beta', 0.6, 1.0), 'gamma': trial.suggest_float('gamma', 40.0, 60.0)}, 
         "probabilistic"),
        ("random_flight", 
         {'scale': trial.suggest_float('scale', 1.1, 1.3), 'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian','levy']), 'beta': trial.suggest_float('beta', 1.2, 1.6)}, 
         "all"),
    ]

# This is the Python Iteration: 8
# Author: [Your Name]
# Date: [Insert Date]
...
heur = [
    ('random_search',
     {'scale': 0.017066435012183176},
     'probabilistic'),

    ('central_force_dynamic',
     {'gravity': 0.10272794660853743, 'alpha': 0.18036927273111406, 'beta': 1.8432046805589337, 'dt': 0.8298512328560507},
     'metropolis'),

    ('firefly_dynamic',
     {'distribution': 'levy', 'alpha': 0.7, 'beta': 1.3, 'gamma': 64},
     'greedy'),

    ('spiral_dynamic',
     {'radius': 0.748513558340217, 'angle': 18.553806225763434, 'sigma': 0.05146073406019401},
     'random')
]    

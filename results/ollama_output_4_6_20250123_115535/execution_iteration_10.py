# This is the Python Iteration: 11
# Author: [Your Name]
# Date: [Insert Date]
...
heur = [
    ...
    (
        ...
        {
            'gravity': 0.06924219981917513,
            'alpha': 0.17789401644297334,
            'beta': 1.520287223213643,
            'dt': 0.8521302565653665
        },
        'probabilistic'
    ),
    (
    ...
    (
        'spiral_dynamic',
        {
            'radius': 0.7960064916966058,
            'angle': 22.681602759371827,
            'sigma': 0.08439621460848687
        },
        'all'
    )
]

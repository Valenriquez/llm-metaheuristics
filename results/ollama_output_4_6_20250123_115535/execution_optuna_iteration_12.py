...
def objective(trial):
    heur = [
        ...
        (
            ...
            {
                'gravity': trial.suggest_float('gravity', 0.01, 0.5),
                'alpha': trial.suggest_float('alpha', 0.02, 0.1),
                'beta': trial.suggest_float('beta', 1.4, 3.0),
                'dt': trial.suggest_float('dt', 0.2, 1.0)
            },
            'metropolis'
        ),
        (
            'differential_mutation',
            {
                ...
                'num_rands': trial.suggest_int('num_rands', 1, 4),
        ...
        (
            'firefly_dynamic',
            {
                ...
                'gamma': trial.suggest_int('gamma', 50, 100)
            },
            'all'
        ),
    ]

...
heur = [
    ('random_search', 
     {'scale': 0.017545024725464202, 'distribution': 'gaussian'}, 
     'metropolis'),
    
    ('central_force_dynamic', 
     {'gravity': 0.007493205882648394, 'alpha': 0.018482821089076305, 'beta': 2.162340875650446, 'dt': 0.9973949315476833}, 
     'probabilistic'),
    
    ('genetic_crossover', 
     {'pairing': 'rank', 'crossover': 'linear_0.5_0.5', 'mating_pool_factor': 0.34829038033713844}, 
     'all')
]    

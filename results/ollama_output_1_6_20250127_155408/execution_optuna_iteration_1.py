...
def objective(trial):
    heur = [
        ...
        ('central_force_dynamic', 
            {'gravity': trial.suggest_float('gravity', 0.0005, 0.002), 'alpha': trial.suggest_float('alpha', 0.005, 0.015), 'beta': trial.suggest_float('beta', 1.0, 2.0), 'dt': trial.suggest_float('dt', 0.8, 1.2)}, 
            'probabilistic'
        ),
        ('genetic_crossover', 
        ...
        ('spiral_dynamic', 
            {'radius': trial.suggest_float('radius', 0.8, 0.9), 'angle': trial.suggest_float('angle', 20, 25), 'sigma': trial.suggest_float('sigma', 0.05, 0.15)}, 
            'all'
        ),
    ]

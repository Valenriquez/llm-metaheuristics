...
def objective(trial):
    heur = [
        ...
        ('central_force_dynamic', 
         {'gravity': trial.suggest_float('gravity', 0.01, 0.2), 'alpha': trial.suggest_float('alpha', 0.02, 0.4), 'beta': trial.suggest_float('beta', 1.5, 4.5), 'dt': trial.suggest_float('dt', 1.0, 2.0)}, 
         'greedy'),
        ('firefly_dynamic', 
         {'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian','levy']), 'alpha': trial.suggest_float('alpha', 1.0, 2.5), 'beta': trial.suggest_float('beta', 1.0, 2.5), 'gamma': trial.suggest_float('gamma', 100.0, 300.0)}, 
         'probabilistic'),
        ('spiral_dynamic', 
         {'radius': trial.suggest_float('radius', 0.7, 0.9), 'angle': trial.suggest_float('angle', 20.0, 25.0), 'sigma': trial.suggest_float('sigma', 0.05, 0.1)}, 
         'all')
    ]

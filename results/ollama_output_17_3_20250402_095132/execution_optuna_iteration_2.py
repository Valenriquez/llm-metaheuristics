...
def objective(trial):
    heur = [
        ('random_search', 
         {'scale': trial.suggest_float('scale', 0.001, 0.1), 'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian'])}, 
         'metropolis'),
        ...
        ('gravitational_search', 
         {'gravity': trial.suggest_float('gravity', 0.2, 1.0), 'alpha': trial.suggest_float('alpha', 0.01, 0.1)}, 
         'greedy'),
    
        ('swarm_dynamic', 
         {'factor': trial.suggest_float('factor', 0.5, 1.5), 'self_conf': trial.suggest_float('self_conf', 2.0, 3.0), 'swarm_conf': trial.suggest_float('swarm_conf', 2.0, 3.0), 'version': trial.suggest_categorical('version', ['inertial', 'constriction']), 'distribution': trial.suggest_categorical('distribution', ['uniform', 'gaussian'])}, 
         'all'),
    ]

...
heur = [
    ...
    (  # Search Operator 2
        ...
        {
            'gravity': 0.2079888660820678,
            'alpha': 0.08145584607116813
        },
        'probabilistic'
    ),
    (  # Search Operator 3
        'firefly_dynamic',
        {
            ...
            'alpha': 1.0279388238675429,
            'beta': 1.0279388238675429,
            'gamma': 51.77634632240052
        },
        'all'
    ),
    (  # Search Operator 4
        'swarm_dynamic',
        {
            'factor': 0.5555089400774792,
            'self_conf': 2.6052696091692833,
            'swarm_conf': 2.1937084682917085,

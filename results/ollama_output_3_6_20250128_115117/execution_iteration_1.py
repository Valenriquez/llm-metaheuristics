...
heur = [
    ...
    ("firefly_dynamic",
     {
         "distribution": "uniform",
         "alpha": 0.5428142533269369,
         "beta": 2.4592626352678737,
         "gamma": 205
     },
     "probabilistic"),
    ("gravitational_search",
     {
         "gravity": 1.3495079900685032,
         "alpha": 0.03
     },
     "all"),
    ("swarm_dynamic",
     {
         "factor": 0.7778810042279001,
         "self_conf": 2.755379305302991,
         "swarm_conf": 2.5814058301998752,
...
optimal_value = fun.optimal_value()

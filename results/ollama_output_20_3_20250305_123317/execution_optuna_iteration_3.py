...
def objective(trial):
    heur = [
        ('central_force_dynamic',
         {
             'gravity': trial.suggest_float('gravity', 0.01, 0.1),
             'alpha': trial.suggest_float('alpha', 0.05, 0.2),
             'beta': trial.suggest_categorical('beta', ['2.0', '3.0']),
             'dt': trial.suggest_categorical('dt', ['0.5', '1.0'])
         },
         'probabilistic'),
        ('random_sample',
         {},
        ...
        ('differential_mutation',
         {
             'expression': trial.suggest_categorical('expression', ['rand-to-best-and-current', 'best-to-current']),
             'num_rands': trial.suggest_categorical('num_rands', ['2', '3']),
        ...
        ('spiral_dynamic',
         {
             ...
             'angle': trial.suggest_categorical('angle', ['30.0', '25.0']),
             'sigma': trial.suggest_float('sigma', 0.1, 0.2)
         },
         'all'),
    ]

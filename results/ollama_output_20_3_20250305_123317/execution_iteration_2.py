...
heur = [
    ("random_search", 
     {'scale': 0.0031729124728045437, 'distribution': 'uniform'}, 
     "metropolis"),
    ("firefly_dynamic", 
     {'distribution': 'uniform', 'alpha': 1.6845741126863971, 'beta': 4.102268768816597, 'gamma': 215}, 
     "greedy"),
    ("gravitational_search", 
     {'gravity': 0.9920389966217265, 'alpha': 0.03}, 
     "probabilistic"),
    ("swarm_dynamic", 
     {'factor': 0.946135624687243, 'self_conf': 2.860979373249722, 'swarm_conf': 2.732471307819469, 'version': 'constriction', 'distribution': 'uniform'}, 
     "all")
]    

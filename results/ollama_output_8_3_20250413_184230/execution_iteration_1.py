...
heur = [
    ('central_force_dynamic', 
     {'gravity': 0.003846890761212153, 'alpha': 0.18671320636199978, 'beta': 3.0663687465593004}, 
     'metropolis'
    ),
    ('differential_mutation', 
     {'expression': 'best', 'num_rands': 2, 'factor': 1.8994485070425182}, 
     'probabilistic'
    ),
    ...
    ('spiral_dynamic', 
     {'radius': 0.7895226528643442, 'angle': 19.854783336978407, 'sigma': 0.15}, 
     'all'
    )
]    

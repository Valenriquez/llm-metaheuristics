...
def objective(trial):
    heur = [
        ('central_force_dynamic', {'gravity': trial.suggest_float('gravity', 0.001, 0.01), 'alpha': trial.suggest_float('alpha', 0.01, 0.2), 'beta': trial.suggest_float('beta', 1.5, 4.5), 'dt': 1.0}, 'metropolis'),
        ('differential_mutation', {'expression': trial.suggest_categorical('expression', ['rand', 'best', 'current', 'current-to-best', 'rand-to-best', 'rand-to-best-and-current']), 'num_rands': 2, 'factor': trial.suggest_float('factor', 1.0, 2.0)}, 'probabilistic'),
        ('gravitational_search', {'gravity': 1.0, 'alpha': trial.suggest_float('alpha', 0.02, 0.04)}, 'greedy'),
        ('spiral_dynamic', {'radius': trial.suggest_float('radius', 0.75, 0.9), 'angle': trial.suggest_float('angle', 10.0, 25.0), 'sigma': 0.15}, 'all')
    ]

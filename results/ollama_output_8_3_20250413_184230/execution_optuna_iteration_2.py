...
def objective(trial):
    ...
    ("central_force_dynamic",
     {
         "gravity": trial.suggest_float('gravity', 0.01, 0.2),
         "alpha": trial.suggest_float('alpha', 0.02, 0.3),
         "beta": trial.suggest_float('beta', 1.5, 4.5),
         "dt": trial.suggest_float('dt', 0.5, 1.0)
     },
     "greedy"),
    ("differential_mutation",
     {
         ...
         "factor": trial.suggest_float('factor', 0.7, 1.2)
     },
     "metropolis"),
    ("spiral_dynamic",
     {
         "radius": trial.suggest_float('radius', 0.8, 0.9),
         "angle": trial.suggest_float('angle', 23, 25),

...
heur = [
    ('random_search', 
     ...
     'metropolis'),
    ('firefly_dynamic',
     {'distribution': 'uniform', 'alpha': 1.5, 'beta': 1.2, 'gamma': 80},
     'probabilistic'),
    ('central_force_dynamic', 
     {'gravity': 0.002, 'alpha': 0.015, 'beta': 1.6, 'dt': 0.9},
     'all'),
    ('swarm_dynamic',
     {'factor': 0.72, 'self_conf': 2.48, 'swarm_conf': 2.57, 'version': 'inertial', 'distribution': 'gaussian'},
     'greedy')
]    

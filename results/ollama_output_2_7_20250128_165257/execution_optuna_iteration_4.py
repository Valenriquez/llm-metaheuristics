...
def objective(trial):
    heur = [
        ('random_search',
        {
            'scale': trial.suggest_float('scale', 0.05, 0.1),
        ...
        {
            'gravity': trial.suggest_float('gravity', 0.03, 0.06),
            'alpha': trial.suggest_float('alpha', 0.01, 0.02),
            'beta': trial.suggest_float('beta', 1.5, 4.5),
            'dt': trial.suggest_float('dt', 0.5, 0.6)
        },
        'probabilistic'
        ),
        ('differential_mutation',
        {
            ...
            'num_rands': 1,
            'factor': trial.suggest_float('factor', 1.4, 1.6)
        },
        'greedy'
        ),
        ('random_flight',
    ...
    performance = evaluate_sequence_performance(heur, prob, num_agents=111, num_iterations=100, num_replicas=30)

...
def objective(trial):
    heur = [
        ('swarm_dynamic', 
            {
                ...
                'self_conf': trial.suggest_float('self_conf', 2.34, 3),
                'swarm_conf': trial.suggest_float('swarm_conf', 2.36, 3),
        ...
        ('spiral_dynamic', 
            {
                'radius': trial.suggest_float('radius', 0.9, 0.9),
                'angle': trial.suggest_float('angle', 10, 25),

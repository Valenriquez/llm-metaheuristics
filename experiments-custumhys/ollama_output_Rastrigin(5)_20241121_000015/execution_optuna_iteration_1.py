    ...
    heur = [
        (  # Search operator 1: Spiral Dynamic
            'spiral_dynamic',
            {
                ...
                'sigma': trial.suggest_float('sigma', 0.01, 3)
            },
            'probabilistic'
        ),
        (  # Search operator 2: Swarm Dynamic
            'swarm_dynamic',
            {
                ...
                'self_conf': trial.suggest_categorical('self_conf', ['inertial', 'constriction']),
                'swarm_conf': trial.suggest_categorical('swarm_conf', ['inertial', 'constriction']),

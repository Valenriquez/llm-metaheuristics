...
class MetaheuristicGenerator:
    ...
    def self_refine_with_optuna(self, model, data_optuna, data, output_folder, number_iteration):
        print("tryint to see the data-", data)
        ...
        while self.file_result != 0: 
            ...
            name_variable: trial.suggest_float('name_variable', 0.1, 0.9) # name_variable must be changed accordingly, here is relevant feedback from past 
            metaheuristics creations that could help you decide the parameters: {data}
            ...
            model="my-new-llama3",
            prompt=refinement_optuna_prompt
            )
    ...
    def run(self):
        ...
        try:
            ...
            for i in range(max_iterations):
                ...
                self.self_refine_with_optuna("my-new-llama3", data_optuna, data, output_folder, i)

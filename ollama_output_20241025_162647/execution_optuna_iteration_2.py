Here is the Optuna-enhanced metaheuristic code based on the provided template:

# Name: Optimized Metaheuristic with Optuna
...
def objective(trial):
    heur = [
        ...
        ("spiral_dynamic",
        {
            ...
            "angle": trial.suggest_float('angle', 1.0, 45.0),
        ...
        ("swarm_dynamic",
        {
            ...
            "self_conf": trial.suggest_float('self_conf', 2.0, 10.0),
            "swarm_conf": trial.suggest_float('swarm_conf', 2.0, 10.0),

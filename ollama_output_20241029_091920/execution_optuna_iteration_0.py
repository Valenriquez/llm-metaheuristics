...
# Name: Optuna-Enhanced Metaheuristic for Levy Search
# Code:
...
def objective(trial):
    heur = [
        ('levy_search', { 'scale': trial.suggest_float('scale', 0.1, 0.9), 'distribution': 'levy', 'beta': trial.suggest_float('beta', 0.1, 10) }, 'probabilistic'),
    ]
